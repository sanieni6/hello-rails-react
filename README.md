...
This is a web application where you can randomly get a greeting from an API. Hello Rails React is an exercise to setup RoR + React as one app with Webpack.
...
```sh
  git clone git@github.com:sanieni6/hello-rails-react.git
